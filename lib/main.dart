...
import 'package:flutter_kotlin_blue_printer/printer_manager.dart';
...
class _PrintersViewState extends State<PrintersView> {
  ...
  _initImg() async {
    try {
      ByteData byteData = await rootBundle.load("images/invoice1.jpg");
      ...
      body: Column(
        children: [
          ...
          ConditionalBuilder(
              ...
              fallback: (context) => const Text("ទៅជាភាសាអង់គ្លេស")),
          const SizedBox(
            height: 15,
          ),
          Container(
